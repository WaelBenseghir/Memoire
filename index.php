...
<body>
    ...
    <main class="main">
        ...
        <section class="hero">
            <div>
                <h2 class="hero__subtitle container">Plantique.</h2>
                <div class="wrapper">
                    <h1 class="item item1">GreenShift</h1>
                    <h1 class="item item2">GreenShift</h1>
                    <h1 class="item item3">GreenShift</h1>
                    <h1 class="item item4">GreenShift</h1>
                    <h1 class="item item5">GreenShift</h1>
                    <h1 class="item item6">GreenShift</h1>
                    <h1 class="item item7">GreenShift</h1>
                    <h1 class="item item8">GreenShift</h1>
                </div>
                <p class="hero__desc">We provide everything from plant diagnosis tools to expert tips,
                    bringing smart solutions directly from our field to yours.</p>
            </div>
            <div class="flex-group-hero">
                <div class="hero__flex">
                    <div class="hero__flex-item">
                        <h2>100+Plants</h2>
                        <p>Explore 100+ plants and get <br>the expert care tips <br>you need.</p>
                    </div>
                    <a href="#explore" class="explore">Explore</a>
                </div>
                <a href="#marketplace" class="btn-home cta-btn">Visit marketplace</a>
            </div>
        </section>
        ...
        <section class="first-section container">
            <div class="grid-group">
                <div class="first-section__text">
                    <h2 class="first-section__title">Your Plant Health Guide</h2>
                    <p class="first-section__subtitle">Get insights and guidance to tackle common plant <br>issues
                        effortlessly.
                    </p>
                </div>
                <div class="first-img"></div>
                <p class="first-section__desc">Explore a simple guide to plant health with practical advice to help
                    farmers solve common crop challenges.</p>
                <a href="#Check" class="cta-btn btnn">Check Your Plants</a>
            </div>
        </section>
        ...
        <section class="second-section container">
            <nav class="section__nav">
                <ul class="section__list">
                    <li class="section__item"><a href="#">Fruit and vegetables</a></li>
                    <li class="section__item"><a href="#">Flowering Plants</a></li>
                    <li class="section__item"><a href="#">Herbs</a></li>
                    <li class="section__item last__item"><a href="#">View More</a></li>
                </ul>
            </nav>

            <div class="flex-group">

                <div class="card flex-item-1">
                    <h2 class="text">Lemons</h2>
                    <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="800" height="800" viewBox="0 0 24 24">
                ...
                <div class="card flex-item-2">
                    <h2 class="text">Tomato</h2>
                    <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="800" height="800" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                            d="M12.293 4.293a1 1 0 0 1 1.414 0l7 7a1 1 0 0 1 0 1.414l-7 7a1 1 0 0 1-1.414-1.414L17.586 13H4a1 1 0 1 1 0-2h13.586l-5.293-5.293a1 1 0 0 1 0-1.414Z"
                            clip-rule="evenodd" />
                ...
                <div class="card flex-item-3">
                    <h2 class="text">Cabbage</h2>
                    <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="800" height="800" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                            d="M12.293 4.293a1 1 0 0 1 1.414 0l7 7a1 1 0 0 1 0 1.414l-7 7a1 1 0 0 1-1.414-1.414L17.586 13H4a1 1 0 1 1 0-2h13.586l-5.293-5.293a1 1 0 0 1 0-1.414Z"
                            clip-rule="evenodd" />
        ...
        <section class="third-section container">
            <h2 class="third-section__title">Our Collection</h2>
            <div class="grid-group-1">
                <div class="card-1 card">
                    ...
                    <div class="txt">
                        ...
                        <p class="txt__desc">Diagnose plant health issues with ease using detailed symptom analysis,
                            tailored care tips, and effective treatments.</p>
                    </div>
                </div>
                ...
                <div class="card-2 card">
                    ...
                    <div class="txt">
                        <h3>Weather</h3>
                        <p class="txt__desc">Stay prepared with real-time weather updates and forecasts tailored to your
                            location for effective farming.</p>
                    </div>
                </div>
                ...
                <div class="card-3 card">
                    ...
                    <div class="txt">
                        <h3>Marketplace</h3>
                        <p class="txt__desc">Discover high-quality products and connect with local sellers to simplify
                            agricultural trading processes.</p>
                    </div>
                </div>
                ...
                <div class="card-4 card">
                    ...
                    <div class="txt">
                        <h3>Community</h3>
                        <p class="txt__desc">Join discussions with farmers, share advice, and learn valuable strategies
                            to improve your practices.</p>
                    </div>
                </div>
    ...
    <footer class="footer">
        <nav class="footer__nav">
            <ul class="footer__list">
                ...
                <div>
                    <li><a href="#diagnostic">Plant Diagnosis</a></li>
                    <li><a href="#Marketplace">Marketplace</a></li>
                    <li><a href="#Weather">Weather</a></li>
                </div>
                <li><a href="#Plants Database">Plants Database</a></li>
            </ul>
        </nav>
        <div>
        </div>
